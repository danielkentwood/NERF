...
% here's an example of what I'll typically need to do
% Full depth search (-r), listing full file name and pattern [-l], as well
% as the file name and line number [-n] of each hit. 
fdir=[experimentHomeFolder 'Code/'];
fpattern = {'dist2targ'};
fl=grep('-r -l -n', fpattern, fdir);
